...
with app.app_context():
    ...
    students = [
        ...
        {'student_id': '2', 'first_name': 'Leo', 'last_name': 'Van Munching', 'email':'vmunch@umd.edu', 'major_id':6,
         'birth_date': dt.datetime(2008, 3, 24), 'is_honors': 0},
    ]

    for each_student in students:
        print(f'{each_student["first_name"]} {each_student["last_name"]} {each_student["email"]} inserted into Student')
